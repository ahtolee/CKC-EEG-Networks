...
% topoplot.m. (Delorme and Makeig 2004) from freely available EEGLAB toolbox (https://sccn.ucsd.edu/eeglab/index.php). 
...
% Visualize CKC results as a topoplot
...
if fdr>0 %Use FDR correction for p-values:
    [h, crit_p, ~, ~]=fdr_bh(pval,p_limit,'pdep','no');  %Apply FDR ocrrection. fdr_bh.m available on the Mathworks File Exchagne    
    sign_mask = double(h);       
