...
% 2) Optional: Topoplot figure that visualizes CKC values projected on a 2D headmap.
...
create_topoplot = 0;    %Create 2D topographic plot of the results (1=yes, 0=no)? Requires installation of EEGLAB toolbox.
